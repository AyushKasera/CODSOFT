...
//        }
    ...
    private fun showData(){
        ...
        fragmentQuizBinding.textViewQuestion.text = resources.getString(R.string.No_of_question_number).plus(" ").plus(questionNumber + 1)

        correctFlag = flagList[questionNumber]

        fragmentQuizBinding.imageViewFlag.setImageResource(resources.getIdentifier(correctFlag.flagsName,"drawable",requireActivity().packageName))
